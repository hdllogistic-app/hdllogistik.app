  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="p-6 rounded-2xl bg-slate-950 border border-slate-800 shadow-xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <div className="inline-block px-3 py-1 rounded-full bg-indigo-500/10 text-indigo-400 text-xs font-bold uppercase tracking-wider border border-indigo-500/20 mb-2">
            Master Data Driver
          </div>
          <h1 className="text-2xl font-bold text-slate-100">HDL LOGISTIK — Pengaturan Driver</h1>
          <p className="text-slate-400 text-sm mt-1">
            Kelola data driver yang digunakan untuk penugasan dan penjadwalan pengiriman.
          </p>
        </div>
      ...
      <DriverSettingsView userRole={user.role} />
    </div>
  );
}
