    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="p-6 rounded-2xl bg-slate-950 border border-slate-800 shadow-xl flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <h1 className="text-2xl font-bold text-slate-100">HDL LOGISTIK — Pengaturan Team</h1>
          <p className="text-slate-400 text-sm mt-1">
            Kelola anggota team berdasarkan divisi dan kebutuhan operasional.
          </p>
        </div>
      ...
      <TeamSettingsView userRole={user.role} />
    </div>
  );
}
